...
Check all items in each dimension that apply to the client. Place a check in the appropriate box that indicates validation of lack of validation for discharge or transfer from this level of care.
  ...
  <TR >
    <TD CLASS="strcol" COLSPAN="2" >
      ...
      a. The client's therapeutic gains in addressing craving and relapse issues have been internalized and integrated so the client does not meet any of the ASAM Level I continued stay criteriain this or another dimension that indicates the need for further treatment in ASAM Level I; or
    </TD>
    <TD CLASS="strcol" COLSPAN="2" >&nbsp;</TD>
  </TR>
  <TR >
