...
<SCRIPT LANGUAGE="JavaScript" SRC="/src/cgi/js/vClientMMSE.js"> </SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="/src/cgi/js/vNum.js"> </SCRIPT>
<SCRIPT LANGUAGE="JavaScript" SRC="/src/cgi/js/qDate.js"> </SCRIPT>

<FORM NAME="MH" ACTION="/src/cgi/bin/mis.cgi" METHOD="POST" >
...
<TABLE CLASS="port fullsize" >
  ...
  <TR CLASS="list hdrcol" >
    <TD COLSPAN="2" >
<A HREF="javascript:InputWindow('/src/cgi/bin/mis.cgi?view=ListClientMMSF.cgi&Client_ClientID=<<<Client_ClientID_1>>>&mlt=<<<mlt>>>&misLINKS=<<<misLINKS>>>&NONAVIGATION=1','MMSE',900,1200)" ><BUTTON TYPE="button" >ENTER Mini-Mental State Examination</BUTTON></A>
    </TD>
  </TR>
