...
<TABLE CLASS="home fullsize" >
  ...
  <TR >
    ...
    <TD CLASS="strcol" > <<<ClientDischargeCDC_TransType_1>>> </TD>
  </TR>
  <TR >
    <TD CLASS="strcol" >Transaction/Contact Date</TD>
    <TD CLASS="strcol" > <<<ClientDischargeCDC_TransDate_1>>> </TD>
  </TR>
  <TR >
    <TD CLASS="strcol" >Transaction/Contact Time</TD>
    <TD CLASS="strcol" > <<<ClientDischargeCDC_TransTime_1>>> </TD>
  </TR>
  <TR >
...
<TABLE CLASS="main fullsize" >
  <TR>
    <TD CLASS="numcol" >
      ...
      <INPUT TYPE="submit" ONCLICK="return validate(this.form);" NAME="UpdateTables=all&misPOP=1&ClientDischargeCDC_CDCOK_1=1" VALUE="Verify/Add/Update" >
    </TD>
  </TR>
</TABLE>
...
// just to OPENTABLES...
//<<<ClientIntake_ServiceFocus_1>>> <<<ClientResources_SelfHelp30_1>>> <<<MedHx_SelfHarm_1>>>
