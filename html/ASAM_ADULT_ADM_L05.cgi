...
<TABLE CLASS="home fullsize" >
  <TR ><TD CLASS="port hdrtxt" COLSPAN="5" >Adult 65D-30 Intervention ASAM Level .05</TD></TR>
  ...
  <TR >
    ...
    <TD CLASS="strcol" COLSPAN="2" >
      Must meet one of the Dimensions of 4, 5, or 6 and any identifiable problems in Dimensions 1, 2 or 3 that are stable or being addressed through appropriate outpatient medical or mental health services.
    </TD>
  ...
  <TR >
    ...
    <TD CLASS="strcol" COLSPAN="2" >
      Willing to understand how current use may affect personal goals - The client expresses a willingness to gain an understanding of how his/her current use of alcohol and /or other drugs may interfere with meeting responsibilities and achieving personal goals.
    </TD>
    <TD CLASS="strcol" WIDTH="5%" >
