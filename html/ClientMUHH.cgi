...
<FORM NAME="HealthHistory" ACTION="/src/cgi/bin/mis.cgi" METHOD="POST" >
...
<TABLE CLASS="main fullsize" >
  <TR >
    <TD CLASS="numcol" >
      <INPUT TYPE=submit ONCLICK="return validate(this.form);" NAME="UpdateTables=all&[[myForm->genLink(ClientIntake+ClientMUH.cgi)]]" VALUE="Add/Update -> Client Health">
