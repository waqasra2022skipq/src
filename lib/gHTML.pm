...
sub setAddional_SCID {
  ...
  my $add_SC_IDS = "(15970, 12785, 12789, 12788, 15888, 21483, 15756, 21500, 21501, 21502, 21503, 21504, 21505, 21506)";
    my $SCIDSel = DBA->selServiceCodes($form,$form->{$column},0,$form->{'LOGINPROVID'},$form->{'Client_ClientID_1'},'Agent',"and xSC.SCNum NOT LIKE 'X%' and (xSC.SCID IN $add_SC_IDS OR `SCNum` LIKE '%90833%' OR `SCNum` LIKE '%96372 25%' OR `SCNum` LIKE '%93000 25%')");
    $out .= qq|
      <TR >
        <TD >
