...
/* create locations */
$locations = array();
$titles = array('Nicetouch Massage Studio', 'Nothern Hill Studio');
foreach( $titles as $t ){
...
/* create resources */
$titles = array( 'George', 'Karen', 'Sarah' );
$resources = array();
...
$resnameSing = 'Therapist';
$resnamePlu = 'Therapists';
...
$conf->set( 'htmlTitle', 'Salon Scheduling' );
?>
