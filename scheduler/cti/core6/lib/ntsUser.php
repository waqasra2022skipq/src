...
class ntsUserIntegrator {
	public $usersById = array();
	public $usersByUsername = array();
	public $cacheCount = array();
	public $idIndex = 'id';
	public $db = null;
...
class ntsUserIntegratorBuiltin extends ntsUserIntegrator {
	public $_users_table_exists = NULL;
...
class ntsAdminPermissionsManager
{
	...
	function __construct(){
		$this->keys = array(
			...
			array( 'admin', M('Sync'), 1 ),
			array( 'admin/sync', M('Sync') ),
