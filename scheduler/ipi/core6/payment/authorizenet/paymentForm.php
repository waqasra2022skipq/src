...
if( $testMode ){
	$paymentUrl = "https://test.authorize.net/gateway/transact.dll"; // test
	}
else {
	$paymentUrl = "https://secure.authorize.net/gateway/transact.dll"; // live
	}
...
<INPUT type="hidden" name="x_relay_url" value="<?php echo $paymentNotifyUrl; ?>">
