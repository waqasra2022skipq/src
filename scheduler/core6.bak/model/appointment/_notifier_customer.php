...
$tags = $om->makeTags_Appointment( $object, 'external', $show_end_time );
...
$cancelLink = ntsLink::makeLink( 'system/appointments/edit', 'cancel', array('auth' => $authCode, 'id' => $object->getId()) );
$cancelLink = '<a href="' . $cancelLink . '">' . M('Cancel') . '</a>';

$tags[0][] = '{APPOINTMENT.QUICK_LINK_CANCEL}';
$tags[1][] = $cancelLink;
