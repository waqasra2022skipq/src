...
nv.models.multiBar = function() {
    ...
    var margin = {top: 30, right: 20, bottom: 50, left: 60}
        ...
        , noData = null
        , dispatch = d3.dispatch('stateChange', 'changeState', 'renderEnd')
        , controlWidth = function() { return showControls ? 480 : 0 }   //kls
        , duration = 250
        , useInteractiveGuideline = false
        ;
...
//alert("cw="+controlWidth+", top="+margin.top+", left="+margin.left);
            ...
            if (!showControls) {
                ...
                g.select('.nv-controlsWrap')
                    .datum(controlsData)
                    .attr('transform', 'translate(' + (controlWidth()-780) + ',' + (-(margin.top)) +')')     //kls
                    .call(controls);
            }
