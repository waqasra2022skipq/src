...
my $UploadButton =
qq|       <INPUT TYPE="submit" ONMOUSEOVER="window.status='upload button'; return true;" ONMOUSEOUT="window.status=''" NAME="view=ERAUpload.cgi&pushID=$form->{LINKID}" VALUE="upload" >|;
