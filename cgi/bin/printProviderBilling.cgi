...
sub createPages {
    ...
    $p->fit_textline( "Primary Billing Source:",
        300, $ypos, $baseboldfontoptions );
    ...
    $p->fit_textline( "Direct Billable Hours:",
        37, $ypos, $baseboldfontoptions );
    $p->fit_textline( $BilledHrs, 150, $ypos, $basefontoptions );

    $p->fit_textline( "Direct Non Billable Hours:",
        300, $ypos, $baseboldfontoptions );
    $p->fit_textline( $NonBilledHrs, 430, $ypos, $basefontoptions );

    $ypos += 25;

    $p->fit_textline( "Reimbursable Amount Expected:",
        37, $ypos, $baseboldfontoptions );
