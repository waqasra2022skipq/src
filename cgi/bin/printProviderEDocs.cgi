...
sub createPages {
    ...
    $p->fit_textline( $rProviderEDocs->{"CreateDate"},
        120, $ypos, $basefontoptions );

    $p->fit_textline( "Public:", 200, $ypos, $baseboldfontoptions );
    $p->fit_textline( $YesNoArr{ $rProviderEDocs->{"Public"} },
        240, $ypos, $basefontoptions );

    my $type =
      DBA->getxrefWithDef( $form, 'xEDocType', $rProviderEDocs->{"Type"},
        'Descr' );
    ...
    $p->fit_textline( $rProviderEDocs->{"Title"}, 100, $ypos,
        $basefontoptions );

    $ypos += 20;

    $p->fit_textline( "Description:", 37, $ypos, $baseboldfontoptions );
    $p->fit_textline( $rProviderEDocs->{"Descr"}, 100, $ypos,
        $basefontoptions );
