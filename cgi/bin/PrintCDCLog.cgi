...
############################################################################
my $select =
qq|select ${table}CDCSent.* from ${table}CDCSent left join ${table}CDC on ${table}CDC.ID=${table}CDCSent.${table}CDCID left join Client on Client.ClientID=${table}CDCSent.ClientID where ${table}CDC.${table}ID=${CDCID} ${ClinicSelection} order by ${table}CDCSent.ChangeDate|;
