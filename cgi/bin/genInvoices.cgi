...
my $cmd = qq|/home/okmis/mis/src/bin/genInvoices DBNAME=$form->{DBNAME}\\&ClientID=$form->{Client_ClientID}\\&mlt=$form->{mlt}|;
warn "cmd=$cmd\n";
...
############################################################################
print  qq|Location: /cgi/bin/mis.cgi?view=ListInvoices.cgi&Client_ClientID=$form->{Client_ClientID}&mlt=$form->{mlt}&misLINKS=$form->{misLINKS}\n\n|;
$form->complete();
exit;
