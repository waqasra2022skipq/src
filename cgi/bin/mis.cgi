...
elsif ( $form->{'MIS_Action'} eq 'MgrTree' || $form->{'MIS_Action'} eq 'ManagerTree' )
{
#warn qq|mis-MgrTree: Action=$form->{'MIS_Action'}\n|;
  $NextLocation = qq|Location: /cgi/bin/ManagerTree.cgi?mlt=$form->{mlt}&misLINKS=$form->{misLINKS}\n\n|;
$disLoc = 'MgrTree';
}
...
{
  $NextLocation = qq|Location: /cgi/bin/ClientList.cgi?Provider_ProvID=$form->{Provider_ProvID}&mlt=$form->{mlt}&misLINKS=$form->{misLINKS}\n\n|;
}
elsif ( $form->{'MIS_Action'} eq 'ChartList' )
{
  $NextLocation = qq|Location: /cgi/bin/ChartList.cgi?Provider_ProvID=$form->{Provider_ProvID}&mlt=$form->{mlt}&misLINKS=$form->{misLINKS}\n\n|;
}
elsif ( $form->{'MIS_Action'} eq 'ClientPage' )
{
  $NextLocation = qq|Location: /cgi/bin/ClientPage.cgi?Client_ClientID=$form->{Client_ClientID}&mlt=$form->{mlt}&misLINKS=$form->{misLINKS}&FULL=$form->{FULL}\n\n|;
}
...
elsif ( defined($form->{'newurl'}) )
{
  ...
  $url =~ s/\^/\&/g;
#warn qq|\nurl=${url}\n|;
  $NextLocation = qq|Location: ${url}&mlt=$form->{mlt}&misLINKS=$form->{misLINKS}\n\n|;
}
elsif ( $form->{'MIS_Action'} eq 'ClientPortal' )
{ $NextLocation = qq|Location: /cgi/bin/ClientPortal.cgi?mlt=$form->{mlt}&misLINKS=$form->{misLINKS}\n\n|; }
elsif ( $form->{'MIS_Action'} eq 'ManagePortal' )
{ $NextLocation = qq|Location: /cgi/bin/ManagePortal.cgi?mlt=$form->{mlt}&misLINKS=$form->{misLINKS}\n\n|; }
elsif ( $form->{'LOGINSCREEN'} ne '' )
{ $NextLocation = qq|Location: /cgi/bin/$form->{LOGINSCREEN}?mlt=$form->{mlt}&misLINKS=$form->{misLINKS}\n\n|; }
else
{
