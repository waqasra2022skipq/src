...
qq|$rClient->{'FName'} $rClient->{'MName'} $rClient->{'LName'} ($rClient->{'ClientID'})|;
    ...
    my %RouteArr = (
        ...
        "102",             "AN,SYMPATHETIC NBLK", "101", "AN,SURFACE", "100",
        "AN,INFILTRATION", "099", "MISCELLANEOUS", "098", "NONHUMAN STUDY",
        "097", "SURGICAL", "096", "SUBCONJUNCTIVAL", "095", "ROUTE NOT GIVEN",
        "094", "SEE PHARM ACTIVITY", "093", "IM - SC",
        "092", "IV - SC",        "091", "IM - IV", "090", "IM - IV - SC", "089",
        "IV(INFUSION)", "088",   "INTERSTITIAL", "072", "INTRAESOPHAGEAL",
        "071", "NASOGASTRIC",    "069", "END", "068", "CONJUNCTIVAL", "067",
        "INTRABRONCHIAL", "066", "SUBARACHNOID",
        "065", "INVITRO",     "061", "INTRAPROSTATIC", "060", "INTRA-AMNIOTIC",
        "059", "NERVE BLOCK", "058", "THROAT",
        "057", "EXTRACORPOREAL", "056",         "INTRA-ABDOMINAL", "055",
        "IONTOPHORESIS", "054",  "VOCAL CORDS", "053",             "SUBMUCOSAL",
        "052", "INTRADURAL", "051", "INTRACERVICAL", "050", "PERIDURAL", "049",
        "INTRATENDINOUS", "048", "INTRAVENTRICULAR",
        "047", "INTRADUODENAL",  "046", "INTRAGASTRIC", "045", "PERIARTICULAR",
        "043", "INTRAPLEURAL",   "042", "INTRALESIONAL",
        "041", "IMPLANTATION",   "040", "PERIODONTAL", "038", "DENTAL", "037",
        "INTRA-ARTERIAL",       "036",           "INTRAOCULAR",
        "035",                  "INTRATRACHEAL", "034", "RETROBULBAR", "033",
        "AN,CNBLK INTRATHECAL", "032", "IRRIGATION", "031", "SEE DOSAGE FORM",
        "030", "BUCCAL", "029", "CAUDAL BLOCK", "028", "INTRAUTERINE", "027",
        "INTRACARDIAC", "026", "DIAGNOSTIC",
        "025", "INTRABURSAL",  "024", "SUBLINGUAL", "023", "INTRACAVITARY",
        "022", "INTRASPINAL",  "021", "INTRAVASCULAR",
        "020", "INTRATUMOR",   "019", "INTRASYNOVIAL", "018", "INHALATION",
        "017", "URETHRAL",     "016", "RECTAL",
        "015", "VAGINAL",      "014", "NASAL", "013", "AURICULAR (OTIC)", "012",
        "OPHTHALMIC", "011",   "TOPICAL",
        "010", "INTRASINAL",   "009", "EPIDURAL", "008", "INTRADERMAL", "007",
        "INTRA-ARTICULAR", "006",           "INTRATHORACIC",
        "005",             "INTRAMUSCULAR", "004", "INTRAPERITONEAL", "003",
        "SUBCUTANEOUS",    "002",           "INTRAVENOUS", "001",     "ORAL",
        "000", "N/A", "N/A", "N/A", "888", "ROUTE", "425", "TRANSENDOCARDIAL",
        "424", "SUBRETINAL",   "423", "SUBGINGIVAL",
        "422", "INTRARUMINAL", "421", "INTRAOMENTUM", "420", "INTRANODAL",
        "419", "INTRAMAMMARY",
        "418", "INTRALINGUAL", "417", "INTRAHEPATIC", "416", "INTRAEPICARDIAL",
        "415", "TRANSPLACENTAL",
        "414", "INTRAPULMONARY", "413", "INTRACAUDAL", "412", "PERINEURAL",
        "411", "PARENTERAL",
        "410", "OROPHARYNGEAL",             "409", "INTRAMENINGEAL", "408",
        "INTRAMEDULLARY", "406",            "INTRACORNEAL",
        "405",            "INTRACISTERNAL", "404", "INTRACEREBRAL", "403",
        "INTRACORPORUS CAVERNOSUM", "402",  "EXTRA-AMNIOTIC",
        "401", "ENDOTRACHEAL", "400", "UNASSIGNED", "366", "INTRATYMPANIC",
        "365", "INTRATYMPANIC",
        "360", "PHOTOPHERESIS", "363", "INTRACARTILAGINOUS", "362",
        "INTRABILIARY", "361",  "INFILTRATION",
        "358", "TRANSDERMAL", "357", "ELECTRO-OSMOSIS", "356", "SPINAL", "355",
        "TRANSTRACHEAL", "354", "INTRAOVARIAN",
        "353", "INTRATUBULAR",  "352", "INTRALYMPHATIC", "315", "INTRAVESICAL",
        "314", "INTRAPERICARDIAL", "313", "ENTERAL",
        "312", "NOT APPLICABLE",   "311", "INTRAVITREAL", "310", "INTRALUMINAL",
        "307", "INTRAGINGIVAL",    "140", "HEMODIALYSIS",
        "139", "UNKNOWN",          "138", "INTRAVENOUS BOLUS",        "137",
        "INTRAVENOUS DRIP", "136", "RESPIRATORY (INHALATION)", "135", "OTHER",
        "134", "OCCLUSIVE DRESSING TECHNIQUE", "133", "ENDOSINUSIAL", "132",
        "INTRACAVERNOUS", "314", "INTRAPERICARDIAL",  "313",          "ENTERAL",
        "131", "ENDOCERVICAL",   "130", "CUTANEOUS", "129", "AURICULAR", "128",
        "INTRAVESICAL", "127",   "INTRAEPIDERMAL",       "120", "ENDOCAVITARY",
        "125",          "PERFUSION, BILIARY", "124",     "TRANSTYMPANIC", "123",
        "INTRADUCTAL",  "122",           "TRANSMUCOSAL", "121", "INTRADISCAL",
        "119",          "INTRACORONARY", "118",     "PERFUSION/CARDIAC", "117",
        "INTRACORONAL, DENTAL", "116", "PERFUSION", "115", "INHALATION, NASAL",
        "114", "SC (INFUSION)", "113", "PERCUTANEOUS", "106", "ORAL-28", "105",
        "ORAL-21", "104",       "FOR RX COMPOUNDING",
        "103",     "INTRATHECAL",
        "112",     "URETERAL", "110", "INTRATESTICULAR", "109", "SOFT TISSUE",
        "108",     "BUCCAL/SUBLINGUAL", "107", "ORAL-20",
    ...
    $p->fit_textline( "Provider Name :", 253.2, $ypos,
    ...
    $p->fit_textline( $MedTypeArr{ $rPDMed->{'MedType'} },
        320, $ypos, $basefontoptions );
    $p->fit_textline( "Active:", 433.3, $ypos, $baseboldmidfontoptions );
    $p->fit_textline( $ActiveArr{ $rPDMed->{'MedActive'} },
        480, $ypos, $basefontoptions );
    ...
    $p->fit_textline( $MedFreqArr{ $rPDMed->{'MedFreq'} },
        220, $ypos, $basefontoptions );
    $p->fit_textline( "Route:", 333.3, $ypos, $baseboldmidfontoptions );
    $p->fit_textline( $RouteArr{ $rPDMed->{'Route'} },
        380, $ypos, $basefontoptions );
    $p->fit_textline( "Physician:", 433.3, $ypos, $baseboldmidfontoptions );
    $p->fit_textline( $physician->{'ProvLastName'},
...
sub createHeader {
    ...
    $sProvider->execute( $rClient->{'clinicClinicID'} )
      || myDBI->dberror(
        "PrintPDMed: select Provider $rClient->{'clinicClinicID'}");
    ...
    my $ClinicPh =
      'Office: ' . $rClinic->{'WkPh'} . '  Fax: ' . $rClinic->{'Fax'};
