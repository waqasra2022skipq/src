    ...
    <xsl:for-each select="/QRDA/procedureListObj/Procedure">
      <entry>
        <procedure classCode="PROC" moodCode="EVN" >
          ...
          <xsl:call-template name="AddCodeNode">
            <xsl:with-param name="codesystem" select="procedurecodeSystem" />
            <xsl:with-param name="code" select="codeCode" />
            <xsl:with-param name="valueset" select="conceptValueOID" />
          ...
          <xsl:choose>
            <xsl:when test="procedureresultcode != ''">
              <entryRelationship typeCode="REFR">
                <observation classCode="OBS" moodCode="EVN">
    ...
    <xsl:for-each select="/QRDA/encounterListObj/Encounter">
      <entry>
        <act classCode="ACT" moodCode="EVN">
          ...
          <id root="55725a20-3eed-0135-62c5-0ac514e14162" />
              ...
              <consumable>
                <manufacturedProduct classCode="MANU">
                  ...
                  <manufacturedMaterial>
                    ...
                    <xsl:call-template name="AddCodeNode">
                      <xsl:with-param name="codesystem" select="manufacturedMaterialObj/codeSystem" />
                      <xsl:with-param name="code" select="manufacturedMaterialObj/manufacturedMaterialTranslationCode" />
                      <xsl:with-param name="valueset" select="manufacturedMaterialObj/valueSet" />
                      <xsl:with-param name="sectiontype" select="'medadministered'" />
                      <xsl:with-param name="text" select="manufacturedMaterialObj/manufacturedMaterialTranslationDisplayName" />
                    </xsl:call-template>
          ...
          <consumable>
            <manufacturedProduct classCode="MANU">
              ...
              <manufacturedMaterial>
                <xsl:call-template name="AddCodeNode">
                  <xsl:with-param name="codesystem" select="manufacturedMaterialObj/codeSystem" />
                  <xsl:with-param name="code" select="manufacturedMaterialObj/manufacturedMaterialCode" />
                  <xsl:with-param name="valueset" select="manufacturedMaterialObj/valueSet" />
          ...
          <xsl:when test="/QRDA/CQMNumber = '68'">
            <entry>
              <organizer classCode="CLUSTER" moodCode="EVN">
                ...
                <!-- This is the templateId for eMeasure Reference QDM -->
                <templateId root="2.16.840.1.113883.10.20.24.3.97"/>
                <id root="1.3.6.1.4.1.115" extension="40280381-52FC-3A32-0153-3D64AF97147B"/>
                <statusCode code="completed"/>
                <!-- Containing isBranch external references -->
                <reference typeCode="REFR">
                  <externalDocument classCode="DOC" moodCode="EVN">
                    <!-- SHALL: This is the version specific identifier for eMeasure: QualityMeasureDocument/id it is a GUID-->
                    <id root="2.16.840.1.113883.4.738" extension="40280381-52FC-3A32-0153-3D64AF97147B"/>
                    <!--CMS68:SHOULD This is the title of the eMeasure -->
